...
const AuthScreen = () => {
  ...
  return (
    <div className="hero-bg relative">
      {/* Navbar */}
      <header className="max-w-6xl mx-auto flex items-center justify-between p-10">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        >
          ...
          <button className="bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:p-2 rounded flex justify-center items-center">
            Get Started
              ...
              <div className="flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2">
                ...
                <div className="flex justify-between items-center w-full">
                  <div className="flex flex-col gap-0">
                    <span className="rounded-t-md lg:text-lg font-bold">
                      Stranger Things
                    </span>
